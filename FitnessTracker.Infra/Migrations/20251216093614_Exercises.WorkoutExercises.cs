...
{
    /// <inheritdoc />
    public partial class ExercisesWorkoutExercises : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightUsed = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_WorkoutExercise_Reps", "[Reps] > 0");
                    table.CheckConstraint("CK_WorkoutExercise_Sets", "[Sets] > 0");
                    table.ForeignKey(
