...
public static class AppConfig
{
    ...
    public static ExternalAuth ExternalAuth { get; private set; } = null!;
    ...
    public static void Init(IConfiguration config)
    {
        ...
        ExternalAuth = config.GetRequiredSection(nameof(ExternalAuth)).Get<ExternalAuth>()!;
    }
}
...
public record ExternalAuth(string FrontendUrl);
